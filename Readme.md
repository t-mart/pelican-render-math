...
Cut from [getpelican/pelican-plugins](https://github.com/getpelican/pelican-plugins).
The goal of this project is to isolate this desired plugin away from the large amount
of other plugins in the above repo. There is precedent for this isolation by the existence
of the many submodules in that repo.

Other features may get added if there is a need.

The license used in the `pelican-plugins` is retained as this specific plugin did not
have one.
